...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2025 at 06:51 AM
...
--
-- Database: `akademik06979`
--
CREATE DATABASE IF NOT EXISTS `akademik06979` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `akademik06979`;
...
(3, 'Screenshot_57.png', 'uploads/resized_Screenshot_57.png');
...
(2, 'Screenshot_57.png', 'uploads/Screenshot_57.png', 'thumbs/thumb_Screenshot_57.png', 226, 227, '2025-04-10 04:47:34');
...
(8, 'pedro', '$argon2id$v=19$m=65536,t=4,p=1$UWMvNC96OWhvamlsdWNJcA$TJYnU4k7qAGYGfd72136Qgyy2ZBCDb3Ixctonb5em9k', 'admin');
COMMIT;
